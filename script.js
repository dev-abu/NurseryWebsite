...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll('.feature, .service-card, .gallery-item, .contact-item');
...
document.addEventListener('DOMContentLoaded', detectThemePreference);
...
// Basic JavaScript functionality for Deeblooms website
